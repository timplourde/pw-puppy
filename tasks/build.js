...
var paths = {
    ...
    bower: [
        ...
        "knockout.animate/src/knockout.animate.js",
        "lodash/lodash.js"
    ]
}
...
gulp.task('bower', function(callback) {
    return projectDir.copyAsync('bower_components', 'app/vendor/bower', {
        overwrite: true,
        matching: paths.bower
    });
});
...
gulp.task('build', ['bower', 'transpile', 'less', 'copy', 'finalize']);
